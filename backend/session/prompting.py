...
def build_system_prompt(
    ...
    return (
        ...
        "marker on its own and nothing after it: [CALL_END]. Never end the "
        "call while you still consider your concern unresolved, or have only "
        f"a vague reassurance with no specifics ({pack.vague_reassurance_examples}) "
        "— keep pushing for specifics instead, the way a real caller would. "
        "Never put the marker in the same reply as a question, and never "
