...
# No account concept exists yet (ADR 0031): every Session is written under the
# same placeholder until ADR 0009's authentication lands.
ANONYMOUS_SUBJECT = "anonym"
