...
/** What kind of call a Scenario is (ADR 0064). The wire carries the English
...
export interface ScenarioDraft {
   ...
   * same list the CHECK constraint holds (ADR 0064). "" is a valid choice. */
