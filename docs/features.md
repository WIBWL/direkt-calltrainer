...
| F-64 | Gesprächsprotokoll als PDF | Das vollständige Transkript wird nach dem Gespräch nicht mehr auf der Seite ausgebreitet, sondern als gestaltetes PDF zum Herunterladen angeboten – mit Zeitmarken, Sprecherkennzeichnung und Seitenumbrüchen. Die Datei entsteht im Browser und wird nicht hochgeladen. | Benutzbarkeit | COULD | F-12, Systementwurf |
