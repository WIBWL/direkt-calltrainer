...
| ADR 0010 | Own PostgreSQL Instance for Session Persistence | vorgeschlagen | C-04, F-12, F-13 |
...
| ADR 0026 | SQLAlchemy 2.0 as ORM | vorgeschlagen | |
| ADR 0027 | Normalized Relational Schema for Session Persistence | vorgeschlagen | F-12, F-13 |
| ADR 0028 | Alembic Migrations Autogenerated from ORM Metadata | vorgeschlagen | |
| ADR 0029 | No Secondary Indexes Beyond Primary/Foreign Keys Yet | vorgeschlagen | |
| ADR 0030 | JSONB for Flexible Per-Measurement Detail Data | vorgeschlagen | |
| ADR 0031 | ER Diagram Generated from ORM Metadata | vorgeschlagen | |
| ADR 0032 | Pseudonymous subject_id Placeholder Instead of a User Foreign Key | vorgeschlagen | C-04, F-31 |
| ADR 0033 | AnalysisJob as a Persisted Entity for Async Job Status | vorgeschlagen | Q-07, F-09 |

Leere Zellen in *Betrifft* sind bewusst gesetzt: ADR 0000 ist eine Dokumentationskonvention ohne Anforderungsbezug, ADR 0018 eine reine Wartbarkeitsentscheidung ohne Entsprechung in Anforderungsliste oder Feature-Katalog. Gleiches gilt für die technischen Detailentscheidungen der Persistenzschicht (ADR 0026, ADR 0028 bis ADR 0031), die lediglich ausgestalten, wie ADR 0010 und ADR 0027 umgesetzt werden.
